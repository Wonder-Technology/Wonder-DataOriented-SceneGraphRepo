...
let _ = describe("Transform", () => {
  ...
  let _judgeOneToOne = ((parent, child), (parentLocalPos, parentPos), (childLocalPos, childPos)) =>
    (
  ...
  let _judgeRotationOneToOne = (
    ...
    (
      ...
      getRotation(child),
    )->expect == (parentLocalRotation, parentRotation, childLocalRotation, childRotation)
  ...
  let _judgeScaleOneToOne = (
    ...
    (getLocalScale(parent), getScale(parent), getLocalScale(child), getScale(child))->expect ==
  ...
  describe("setParent", () => {
    describe("the change of parent before setted as parent will affect child", () => {
      test("test one(parent)-one(child)", () => {
        ...
        _judgeOneToOne((parent, child), (pos, pos), (TransformTool.getDefaultPosition(), pos))
      })
    ...
    describe("fix bug", () =>
      test("test two(parent)-two(child)", () => {
        ...
        )->expect == (pos1, pos2, PositionTool.add(pos3, pos1), PositionTool.add(pos4, pos2))
      })
    )
  })
  ...
  describe("setLocalPosition", () => {
    ...
    test("change parent's localPosition should affect children", () => {
      ...
      _judgeOneToOne((parent, child), (pos2, pos2), (pos2, PositionTool.add(pos2, pos2)))
    })
    test("change child's localPosition shouldn't affect parent", () => {
      ...
      _judgeOneToOne((parent, child), (pos1, pos1), (pos1, PositionTool.add(pos1, pos1)))
    })
  })
  ...
  describe("setPosition", () =>
    describe("set position in world coordinate system", () => {
      ...
      test("change child's position shouldn't affect parent", () => {
        ...
        _judgeOneToOne((parent, child), (pos1, pos1), ((1., 1., 1.)->PositionTool.create, pos3))
      })
    })
  )
  ...
  describe("getEulerAngles", () => {
    test("default value should be (0.,0.,0.)", () => {
      ...
      getEulerAngles(transform)->expect == (0., -0., 0.)->EulerAnglesTool.createFromPrimitive
    })
    test("get the eulerAngles in world coordinate system", () => {
      let parent = create()->ResultTool.getExnSuccessValue
      let child = create()->ResultTool.getExnSuccessValue
      let eulerAngles = (45., 45., 90.)->EulerAnglesTool.createFromPrimitive
      setLocalEulerAngles(parent, eulerAngles)->ResultTool.getExnSuccessValue
      setParent(parent, child)->ResultTool.getExnSuccessValue
    ...
    describe("set eulerAngles in world coordinate system", () => {
      let _judgeEulerAnglesOneToOne = (
        ...
        (
          ...
          (parentLocalEulerAngles, parentEulerAngles, childLocalEulerAngles, childEulerAngles)

      test("change parent's eulerAngles should affect children", () => {
        let parent = create()->ResultTool.getExnSuccessValue
        let child = create()->ResultTool.getExnSuccessValue
        let eulerAngles1 = (1., 2., 3.5)->EulerAnglesTool.createFromPrimitive
        let eulerAngles2 = (5., 10.5, 30.)->EulerAnglesTool.createFromPrimitive
        setLocalEulerAngles(parent, eulerAngles1)->ResultTool.getExnSuccessValue
        setLocalEulerAngles(child, eulerAngles2)->ResultTool.getExnSuccessValue
        setParent(parent, child)->ResultTool.getExnSuccessValue
      ...
      test("change child's eulerAngles shouldn't affect parent", () => {
        ...
        let eulerAngles3 = (2.5, 3.5, 4.5)->EulerAnglesTool.createFromPrimitive
        setLocalEulerAngles(parent, eulerAngles1)->ResultTool.getExnSuccessValue
        setLocalEulerAngles(child, eulerAngles2)->ResultTool.getExnSuccessValue
        setParent(parent, child)->ResultTool.getExnSuccessValue
  ...
  describe("rotateLocalOnAxis", () =>
    test("rotate on local axis in the local coordinate system", () => {
      ...
      rotateLocalOnAxis(tra1, (45.->AngleTool.create, yAxis))->ResultTool.getExnSuccessValue
      rotateLocalOnAxis(tra1, (45.->AngleTool.create, xAxis))->ResultTool.getExnSuccessValue
      rotateLocalOnAxis(tra1, (10.->AngleTool.create, yAxis))->ResultTool.getExnSuccessValue
  ...
  describe("rotateWorldOnAxis", () =>
    test("rotate on world axis in the world coordinate system", () => {
      ...
      rotateWorldOnAxis(tra1, (45.->AngleTool.create, yAxis))->ResultTool.getExnSuccessValue
      rotateWorldOnAxis(tra1, (45.->AngleTool.create, xAxis))->ResultTool.getExnSuccessValue
      rotateWorldOnAxis(tra1, (10.->AngleTool.create, yAxis))->ResultTool.getExnSuccessValue
  ...
  describe("fix bug", () => {
    ...
    test("get the data from Float32Array may not equal to the value which is setted", () => {
      ...
      getLocalPosition(transform0)->expect == (0.10000000149011612, 0., 0.)->PositionTool.create
    })
    ...
    describe("fix rotate on axis", () => {
      let _test = (expectedLocalEulerAngles, toFixFunc) => {
        ...
        let localRotation = (-0.02508343756198883, 0., 0., 0.5063101649284363)->RotationTool.create

        setLocalRotation(transform, localRotation)->ResultTool.getExnSuccessValue
      ...
      test("the euler angle after rotate on axis is wrong", () => _test((9.811, 0., 0.), _ => ()))
