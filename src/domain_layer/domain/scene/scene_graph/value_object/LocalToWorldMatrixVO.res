type t = LocalToWorldMatrix(TransformPOType.localToWorldMatrix)
...
let getTranslation = mat => Matrix4.getTranslationTuple(mat->value)->PositionVO.create

let getRotation = mat => Matrix4.getRotationTuple(mat->value)->RotationVO.create
