...
let getLocalToWorldMatrixTypeArray = (index, typeArr) =>
  TypeArrayRepoUtils.getFloat16TypeArray(getLocalToWorldMatrixIndex(index), typeArr)
...
let setLocalToWorldMatrix = (index, data, typeArr) =>
  TypeArrayRepoUtils.setFloat16(getLocalToWorldMatrixIndex(index), data, typeArr)
